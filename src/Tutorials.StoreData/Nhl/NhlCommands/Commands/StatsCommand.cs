...
public class StatsCommand : NhlBaseCommand
{
    ...
    public override RunResult Run()
    {
        ...
        if(HasOption("goalies")) ShowGoalies(seasonId, nations, take, name, atLeastGameCount);
        else ShowSkaters(seasonId, nations, take, name, atLeastGameCount);
        
        return Ok();
    }
    public void ShowSkaters(int seasonId, List<string> nations, int take, string name, int atLeastGameCount)
    {
    ...
    public void ShowGoalies(int seasonId, List<string> nations, int take, string name, int atLeastGameCount)
    {
